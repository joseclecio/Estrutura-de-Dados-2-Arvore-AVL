...
public class TestePilha {
    ...
    public void testRemover() {
        ...
        /*
         * Teste de remo��o com a pilha vazia
         */
        assertFalse(this.pilha.remover());
        assertEquals(this.pilha.toString(), "*");

        /*
         * Teste de remo��o com a pilha contendo um �nico elemento
         */
        this.pilha.inserir(1);
        ...
        /*
         * Teste de remo��o com a pilha contendo mais do que um elemento
         */
        this.pilha.inserir(1);
        this.pilha.inserir(2);
        this.pilha.inserir(3);
    ...
    public void testLimpar() {
        ...
        /*
         * Teste de limpeza quando a pilha j� est� vazia
         */
        this.pilha.limpar();

        assertEquals(this.pilha.toString(), "*");
        /*
         * Teste de limpeza quando a pilha n�o est� vazia
         */
        this.pilha.inserir(1);
        this.pilha.limpar();
